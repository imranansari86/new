...
function Controller() {
    ...
    this.__controllerPath = "GuideInfoScreen";
    ...
    var exports = {};
    var __defers = {};
    $.__views.guideInfoScreen = Ti.UI.createWindow({
        titleAttributes: {
            color: "#fff",
            font: {
    ...
    $.__views.guideInfoScreen && $.addTopLevelView($.__views.guideInfoScreen);
    ...
    $.__views.__alloyId45.add($.__views.settingButton);
    ...
    $.__views.__alloyId45.add($.__views.notificationButton);
    ...
    $.__views.guideInfoScreen.rightNavButton = $.__views.__alloyId45;
    $.__views.__alloyId46 = Ti.UI.createView({
        top: 0,
        layout: "vertical",
        id: "__alloyId46"
    });
    $.__views.guideInfoScreen.add($.__views.__alloyId46);
    ...
    $.__views.__alloyId46.add($.__views.View);
    ...
    $.__views.guideInfoScreen.add($.__views.ActivityView);
