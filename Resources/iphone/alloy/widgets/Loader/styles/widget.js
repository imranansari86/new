...
module.exports = [ {
    ...
    isApi: true,
    queries: {
        "if": "Alloy.Globals.iPhoneFive"
    },
    priority: 1603.0014999999999,
    key: "TextField",
    style: {
        font: {
            fontSize: 15,
